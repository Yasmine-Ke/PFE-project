    ...
    <nav>
       <div className="container">
        ...
        <div className="content">
          ...
          placeholder="Choisir un patient"   value={name + prenom}
...
<section >
       ...
       <div class="dash-content1">
           ...
           <div class="activity1">
            ...
            <button class="bx bx-check icon data-list1 my" onClick={() => handleEdit(patient)} ></button>
                   ...
                   <div class="data1 names">
                      ...
                      <span class="data-list1">{patient.Name} {patient.prenom}</span>
                      ))}
                   </div>
          ...
          placeholder="Enter date" />
              ...
              <div className="input-box">
                <span className="details">L'intitule </span>
                <input    
          value={type}
          onChange={(e) => setype(e.target.value)} required
          placeholder=" Entrer lobjet du bilan " />
              </div>
              <div className="input-box">
