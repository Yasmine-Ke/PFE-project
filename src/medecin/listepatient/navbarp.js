...
import ProfilM from '../profil/profil';
import Bilan from '../bilan/bilan';
import secretary from '../profil/secretary.png'
    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="/medecin/rdv">
                    <i class="bx bxs-calendar-event icon"></i>
                    <span class="link-name">Rendez-vous</span>
                </a></li>
                <div class="div">
                <li><a href="/medecin/patient2">
                ...
                <li><a>
                    ...
                    <span class="link-name" onClick={handleShowBilan} >Bilans</span>
                    {showBilan ? (
        <div className="modal-overlay" onClick={handleCloseBilan}>
