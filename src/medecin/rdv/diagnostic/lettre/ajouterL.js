...
export default function AjouterL(){
 ...
 //le nom du patient quia ete recuperer a partir de liste quand il a clique sur fetch 
  ...
  const [prenomp, setprenom] = useState(prenom);
  ...
  const handlepatientpChange = event => {
...
<div class="data id">
   ...
   <input class="info2" value={prenomp} onChange={handlenameAChange}
...
<div class="btns">
<div className="button1">
              <input type="submit" value="annuler"onClick={handleClosePopupP1} />
            </div>
