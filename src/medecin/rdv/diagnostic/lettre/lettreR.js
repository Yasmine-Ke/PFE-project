...
import AjouterC from '../compteR/ajouterC';
...
const genre=patient.genre;
    ...
    const handleSelectionner = (lettre) => {
      
      // Sauvgarder le patient in localstorage 
      localStorage.setItem('idlettre', JSON.stringify(lettre));
      
      //rederiger vers la page compteR :)
...
<span class="data-list">{nameM}</span>
               ...
               <div class="button"  onClick={() => handleSelectionner(ordonnance.idC)}>selectionner</div>
            </div>
