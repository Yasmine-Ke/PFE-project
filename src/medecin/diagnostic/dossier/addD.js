...
<div class="dash-info2">
  ...
  <div class="data id">
      <label class="data-title">Séance</label>
      <input onClick={handleShowPopupP} type="text" class="input-small" value={idR} onChange={handleidcChange}  disabled={isDisabled} />
    </div>
    {showPopupP ? (
...
<div class="data3 names">
                     ...
                     <span class="data-title3">Référence rdv </span>
                 ...
                 <div class="data3 names">
                     ...
                     <span class="data-title3">Nom P </span>
                 ...
                 <div class="data3 names">
                     ...
                     <span class="data-title3">Prénom P </span>
                    ...
                    <span class="data-list3">{prenom}</span>
                    ))}
                     </>
                    ))}
                 </div>
    ...
    <div class="data type">
      ...
      <input  type="date" class="input-small" value={dateC} onChange={handledatecChange}  disabled={isDisabled}  />
    </div>
    <div class="data id">
