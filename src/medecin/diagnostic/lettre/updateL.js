...
export default function UpdateL(){


  const updatel = JSON.parse(localStorage.getItem('updatel'))
  const updateidRl = JSON.parse(localStorage.getItem('updateidRl'))
  const updatedatel = JSON.parse(localStorage.getItem('updatedatel'))
 
  const updatenamedl = JSON.parse(localStorage.getItem('updatenamedl'))
  const idDCupdatel = JSON.parse(localStorage.getItem('idDCupdatel'))
  ...
  const [idR, setidR] = useState(updateidRl);
  const [medecinD, setmedecin] = useState(idDCupdatel);
  const [dateAjr, setDate] = useState(updatedatel);
  const [dateN, setdateN] = useState(date);
  const [nameD, setidP] = useState(updatenamedl);
  const [contenu, setcontenu] = useState(updatel);
