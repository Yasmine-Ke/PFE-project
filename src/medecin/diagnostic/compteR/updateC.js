...
export default function UpdateC(){
  ...
  const updateC = JSON.parse(localStorage.getItem('updateC'))
  const updateidRC = JSON.parse(localStorage.getItem('updateidRC'))
  const updatedateC = JSON.parse(localStorage.getItem('updatedateC'))
  const updateidLC = JSON.parse(localStorage.getItem('updateidLC'))
  const updatenamedC = JSON.parse(localStorage.getItem('updatenamedC'))
  const idDCupdate = JSON.parse(localStorage.getItem('idDCupdate'))
  ...
  const [idC, setidc] = useState(updateidLC );
  const [idR, setidR] = useState(updateidRC);
  const [medecinD, setmedecin] = useState(idDCupdate);
  const [dateAjr, setDate] = useState(updatedateC , '');
  const [dateN, setdateN] = useState(date);
  const [nameD, setidP] = useState(updatenamedC);
  const [contenu, setcontenu] = useState(updateC ,'' );
...
<div class="dash-info2">       
         ...
         <input class="datee"  onClick={handleShowLL} value={idC}
...
<div class="data id">
    ...
    <span class="data-title">Le medecin destinataire: </span>
   <input class="info2" value={nameD} 
...
<div className="button1">
            ...
            <div className="button">
              <input type="submit" value="modifier" onClick={handleSubmit} />
            </div>
