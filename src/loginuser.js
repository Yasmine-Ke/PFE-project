...
export default function Loginuser(){
  ...
  const handleSubmit = async (e) => {
    ...
    if (data.error) {
        alert(data.error);
      } else if (!data.iduser) { // Ajouter un bloc else if pour gérer le cas où les informations d'identification sont incorrectes
        alert("Nom d'utilisateur ou mot de passe incorrect.");
      } else {
       
    
        if (data.poste === 'Directeur'){
          window.location.href = '/directeur/acceuil';

        } else {
          window.location.href = '/patient';
          localStorage.setItem('userId', data.iduser);
          localStorage.setItem('usernameA', data.Name);
                ...
                <div class="form-content">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div class="field input-field">
                            <textarea type="text" placeholder="nom d'utilisateur"    value={username}
